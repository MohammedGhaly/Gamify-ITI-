    ...
    >
      ...
      >
        ...
        >
          ...
          <Text
            ...
            fontWeight={600}
          >
            Unleash Your Gaming Potential, Discover Your Next Adventure ,Join
      ...
      <Grid mt={20} templateColumns="repeat(1, 1fr)" gap={6}>
        <GridItem width="100%" textAlign="center" mt={{ base: 12, md: 200 }}>
          <Heading size={{ base: "xl", md: "2xl" }} color="#ff8800">
            Gaming Without Borders, Our Global Presence
          </Heading>
          <Text fontSize={{ base: "md", md: "lg" }} pt={4}>
            A Global Playground for Gamers, Discover Our Worldwide Gaming
            Hotspots.
          </Text>
        </GridItem>
        ...
        <GridItem>
          ...
          >
            ...
            {locations.map((location) => (
              <Tooltip bg="#ff8800" label={location.label} key={location.id}>
                <Box
                  position="absolute"
                  top={location.top}
                  left={location.left}
      ...
      <Grid>
        ...
        >
          ...
          <Text
            ...
            textAlign="center"
          >
            Join Thousands of Happy Players. Your Voice, Our Game: Player
            Testimonials
          </Text>
            ...
            >
              <Flex alignItems="center" mb={4}>
                ...
                <Box>
                  ...
                  <Text fontWeight="100">Warsaw, Poland</Text>
                </Box>
              ...
              <Text fontSize={{ base: "md", md: "lg" }}>
                As a long-time gamer, I appreciate the level of detail and
                customization options. Feels like the game is made for true
                fans!
              </Text>
            </Box>
            ...
            >
              <Flex alignItems="center" mb={4}>
                ...
                <Box>
                  ...
                  <Text fontWeight="100">Shanxi, China</Text>
                </Box>
                <Flex ml="auto" alignItems="center">
                  <Text mr={1} fontSize="lg">
                    5
              ...
              <Text fontSize={{ base: "md", md: "lg" }}>
                Epic events and challenges! Always something new to do. This is
                my go-to gaming site..
              </Text>
            </Box>
            ...
            >
              <Flex alignItems="center" mb={4}>
                ...
                <Box>
                  ...
                  <Text fontWeight="100">Seoul, South Korea</Text>
                </Box>
                <Flex ml="auto" alignItems="center">
                  <Text mr={1} fontSize="lg">
                    4
              ...
              <Text fontSize={{ base: "md", md: "lg" }}>
                Great variety of games! The only downside is occasional server
                lag, but overall, it has been a blast.
              </Text>
            </Box>
          </Flex>
        </GridItem>
        ...
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          >
            ...
            <VStack align="start">
              ...
              <Link fontSize={{ base: "sm", md: "md" }} href="#">
                Zeux
              </Link>
              <Link fontSize={{ base: "sm", md: "md" }} href="#">
                Portfolio
